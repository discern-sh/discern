...
const LEDE =
  `_A maintained reference to the coding-agent differences discern must handle: hooks, sandboxes, working-directory and session semantics, worktree mechanisms, and configuration surfaces. It gives maintainers one evidence-backed place to answer why agents behave differently._`;
...
>
> **Freshness.** Flags, defaults, and tool surfaces change between releases. Most behaviors are pinned to mid-2026. MCP schema discovery was re-verified on 2026-08-02 against Claude Code 2.1.212, Codex \`rust-v0.146.0\`, Cursor's current documentation, Gemini CLI v0.53.1, and Copilot CLI 1.0.77. Re-verify a cell before relying on it as current.`;
