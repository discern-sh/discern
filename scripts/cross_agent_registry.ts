...
>
> **Companion.** [Agent integration coverage](agent-integration-coverage.md) records what discern wires for each agent: the Guidance file, Skills directory, Model Context Protocol (MCP) server, and worktree hooks. This page records the vendor capabilities that coverage cites.
>
