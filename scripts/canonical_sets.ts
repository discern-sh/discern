...
export const CANONICAL_SETS: readonly CanonicalSetEntry[] = [
  ...
  },
  {
    ...
    what:
      "Dead config positions, command suggestions, and grammatical command variants.",
    source: {
      kind: "module",
      module: "src/shared/vocabulary.ts",
      exportName: "DEAD_CONFIG_POSITIONS",
    },
    ...
    enrolledIn: {
      glossary: {
        absent:
          "dead positions and input normalizations are implementation policy",
      },
