...
/**
 * Route one technical-register field through the scriptorium's provenance
 * channel; outside the scriptorium the text passes through unchanged.
 */
...
/**
 * Route one benefit-canon field through the scriptorium's provenance channel;
