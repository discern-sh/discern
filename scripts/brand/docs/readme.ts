...
export const PRECEDENCE = [
  {
    ...
    detail:
      "canonical registries, live behaviour, source code, generated canon, setup contract, and documentation.",
  },
  {
...
export const OUTSTANDING_WORK = [
  {
    ...
    summary:
      "Rewrite the complete root-level README.md file, basing it upon the new branding and messaging rules.",
  },
  {
  ...
  },
  {
    ...
    summary:
      "Number the WIP ADR in `decisions.md` and publish it permanently into `project/map/_adr/` at the end of the effort. Add a second ADR to note about canonicalising the brand docs themselves.",
  },
  {
  ...
  },
  {
    ...
    task: "Registry canonicalisation",
    summary:
...
export function renderReadmeDoc(
  ...
  return [
    ...
    "## Purpose",
    "",
    "This directory keeps discern's public strategy coherent while preserving a strict boundary between three different communication jobs:",
    "",
    ...
    "",
    "All three registers share the same product truth. They do not share the same surface voice.",
    "",
    "The system exists to prevent two recurring failures:",
    "",
    bullets([
    ...
    "",
    "The line carries two compatible readings:",
    "",
    bullets([
    ...
    "",
    "The Brand Operating System should reduce context, not create another context burden.",
    "",
    ...
    "### The product name",
    "",
    "The name is always written **discern** — entirely lower-case, in every register and every position, including at the start of a sentence or headline. Recast the line rather than capitalising the name. Display styling is a design-system decision; the spelling never changes.",
    "",
    "### Product vocabulary",
    "",
    ...
    "### Creative lines",
    "",
    "Lines in `messaging.md` are approved territories and candidate expressions, not mandatory slogans. Choose the line that serves the page. Avoid forcing one headline across every surface.",
    "",
    "### Evidence",
    "",
...
\`\`\``,
    ...
    bullets([
      ...
      "link and enrolment checks across this directory.",
    ]),
    "",
    "## Working summary",
    "",
