...
export function renderReadmeDoc(
  ...
  return [
    ...
    "",
    `**Stays private?** marks a document that stays authored under \`_private\`, outside the brand registry, and is wiped before the repository goes public. It remains locally as a private overlay, where the document-map links resolve. Unmarked documents are registry-owned: their source of truth is in \`scripts/brand/\`, and their generated pages live here under \`_internal/brand/\`. Dated internal snapshots, demand-evidence sweeps, the anecdote ledger, and claims requiring future validation live in \`claims-residue.md\`.`,
    "",
