/**
 * The copy review as a prose-led registry module: the three scorecards and
 * the automatic-failure list live as typed data; the review procedures stay
 * authored Markdown sections. `copy-review.md` compiles from this module.
 */
