...
export function renderPositioningDoc(): string {
  return [
    ...
    "",
    "The {{doc:readiness-canon}} connects each question to the features and benefits that help answer it. It gives public storytelling a recognizable starting point: something the reader already wants their software to be ready for. Consequential Code remains the worldview; the engineering practice remains the category.",
    "",
    "## The organizing idea",
    "",
    ...
    "",
    "The relationship persists as people, providers, tasks, and scale change. {{doc:visual-identity}} records its expression in the mark and the extended visual language.",
    "",
    "## Category",
    "",
    ...
    "",
    "This territory should make discern enjoyable to promote and exciting to discover. The energy comes from specificity — a named moment, a ledger fact, or the paradox made literal; {{doc:messaging}} holds the full headline inventory.",
    "",
