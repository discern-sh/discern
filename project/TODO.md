...
- [ ] **Enroll Readiness in Canon Editor when question editing is needed.** Add a Readiness projection and editable question, approach, and route fields through the existing snapshot, field, and picker contracts. Keep `scripts/brand/readiness.ts` authoritative. Evidence: `scripts/canon_editor/`; `project/map/_adr/0391-readiness-connects-questions-to-the-practice.md`.
