...
_Unscheduled ideas live as one note each in [`map/_private/ideas/`](map/_private/ideas/README.md) — see its README for the index and note format. Record new ideas there, not here; when one graduates to real work, delete its note in the commit that creates the backlog item._
