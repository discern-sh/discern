...
Understand Standards as one-way retained gains, including why a passing number is not an arbitrary quality score.
...
_The [practice](../30-reference/glossary.md#practice) discern installs, as numbered tenets: the obligations that hold for every change, and for the practice's own conduct. The [concepts page](practice-and-roles.md) tours the mechanisms; this page states what they add up to._
