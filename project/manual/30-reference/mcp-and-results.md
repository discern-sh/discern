...
| `discern_accept`            | `action`, `target`, `prepare`, `preparation`, `met`, `reason`, `confirmation`, `recover`, `dry_run`, `confirmed`, `variance`, `approve_standard`, `path` |
| `discern_test`              | `path`                                                                                                                                                   |
