...
| `concurrent_test_runs` | number  | `1`     | Repository-wide cap on concurrent test-stage runs; excess runs wait. Fresh projects use 1; 0 is uncapped. `discern queue -- <command>` shares the cap.                                                          |
