...
| `data.managed_version`                                | Running version, optional project adoption version, and their SemVer comparison. Missing adoption makes no claim.                                                                                                                                       |
| `data.managed_currency_unavailable`                   | The running binary is older than the project's adoption; managed-template currency is unverified. It is advisory in status and doctor.                                                                                                                  |
