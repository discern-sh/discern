...
| Option                       | Description                                                                                                                                                                                                                                                     |
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--recover <environment-id>` | Return this owned execution environment and reconcile its queue reservation without running validation or landing.                                                                                                                                              |
...
Accept and land this worktree's finished branch on the trunk, the shared landing branch. Tracked refresh artifacts must already be current. After landing, materialize checkout-local Agent artifacts, then remove the worktree and merged branch. Use accept emergency --reason <text> to review an explicit exception against actual trunk. Emergency integration requires fresh exact owner confirmation and issues no passing Proof.
