...
| `--unmet <id>`                    | Answer one checkpoint question as unmet, with `--why`: a question about the combined code, with `--composition-receipt`, or an emergency question, with `accept emergency --prepare`. Landing then needs the owner's variance.                                                                                                 |
