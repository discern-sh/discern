...
- **Document every function declaration.** Put a JSDoc block immediately before every authored TypeScript `function` declaration, including private, nested, and test helpers. [`scripts/function_docblock_lint.ts`](../../../scripts/function_docblock_lint.ts) catches the declaration during normal lint; [`tests/function_docblock_lint_test.ts`](../../../tests/function_docblock_lint_test.ts) runs the same AST rule over the Git-derived authored TypeScript universe, including files excluded from normal lint ([ADR 0250](../_adr/0250-function-declarations-require-jsdoc.md)). Methods, arrow functions, function expressions, and type signatures are separate syntax families and stay outside this rule.
