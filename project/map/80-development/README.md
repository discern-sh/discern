...
| [install-surface.md](install-surface.md)                     | What `discern setup begin` lays down in a project, mapped by function, with each part's project-owned / shared / generated ownership and where to change it.                                                        |
| [maintenance.md](maintenance.md)                             | How to remove unreachable exports, interpret clone and file-complexity evidence, preserve coherent ownership, and pin each measured reduction.                                                                      |
...
| [terminal-applications.md](terminal-applications.md)         | Package application composition, product interaction policy, native input ownership, and testing migration limits.                                                                                                  |
...
| [canon-editor.md](canon-editor.md)                           | Canon Editor edits the five prose registries through their generated pages, with annotated fields, typed pickers, save-and-prove write-back, live register lint, and guard-net enrollment.                          |
...
| [duplication-census.md](duplication-census.md)               | How the repository tracks and reduces duplicated code.                                                                                                                                                              |
