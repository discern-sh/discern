...
| [reviewing-terminal-output.md](reviewing-terminal-output.md) | The real-PTY see-judge-adjust loop for terminal changes: capture before and after, inspect package-projected HTML, hand off its path, and review flagship fixture diffs.                                            |
