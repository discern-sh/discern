...
- `start` provisions an isolated checkout for a change (see the worktree note in the project guidelines).
...
| [install-surface.md](install-surface.md)     | What `discern setup` lays down in a project, mapped by function, with the yours / co-managed / generated disposition of each part and where to change it.                                                                 |
