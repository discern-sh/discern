...
| [maintenance.md](maintenance.md)                             | How to use maximal clone diagnostics to remove incidental duplication, preserve independent behavior, and pin each measured reduction.                                                                              |
