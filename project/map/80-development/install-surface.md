...
| **the binary's** | Re-published artifacts: gitignored materialized-skills dirs (`.claude/skills/`, `.agents/skills/`) and tracked agent files. Produced from the bundled sources and safe to overwrite.                     | Re-published — overwritten to match the binary.                                                                                                                                                                                                                                       | Edit the source (in this repo) and re-run the producing command.                                                        |
