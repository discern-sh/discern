...
[`src/lib/tidy_format.ts`](../../../src/lib/tidy_format.ts) owns the fixed Markdown and TOML settings and lazily instantiates the vendored dprint plugins under [`src/lib/tidy_plugins/`](../../../src/lib/tidy_plugins/). For TOML it composes the depth indenter ([`src/lib/toml_indent.ts`](../../../src/lib/toml_indent.ts)) after the plugin, producing the indented canonical form ([ADR 0220](../_adr/0220-depth-indent-discern-toml.md)). [`scripts/build.ts`](../../../scripts/build.ts) includes that directory in every compiled binary. No plugin download occurs during build or at run time.
