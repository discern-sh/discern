...
under [`src/engine/`](../../../src/engine/). A project never has a committed
copy of the engine — it lives in the binary
...
[`project/guidance.md`](../../guidance.md) by `discern refresh`. Edit that
...
[`src/engine/mcp/server.ts`](../../../src/engine/mcp/server.ts). The default
opens the browser UI; append `--cli --method tools/list` (or
...
maintainer dependency — commented in the [`Brewfile`](../../../Brewfile);
