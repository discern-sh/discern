...
| [`discern-set-a-checkpoint`](../../../templates/skills/discern-set-a-checkpoint/SKILL.md)     | A recurring review judgment should be served when a matching change completes — trigger, mode, and criterion wired as a `[checkpoints.<id>]` entry.   |
