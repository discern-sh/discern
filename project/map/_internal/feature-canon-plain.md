...
- **When the work itself crosses a limit** — When the work itself crosses a limit, the person responsible decides whether it should move. After the intended version is committed, discern measures that quality again and carries the value, reason, and responsible files into the final review.
