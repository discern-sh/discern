...
| **Instructions**          | One authored source compiled into each configured provider's instruction surface.                                                                           | The project is re-explained in every session and provider.                                    | Every agent starts with the same project understanding.                  | “Shared project instructions, written once and supplied to every agent.”                  | Yes, as a benefit.                     | Autonomous learning or a model inside discern.                                                               |
