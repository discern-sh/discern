...
| [`for-agents-brief.md`](../../_private/brand/for-agents-brief.md)                                 | Operational     | Defines the dedicated For Agents page, `llms.txt`, and the creative “marketing to the machines” programme.                                                                  | private overlay (local) |
...
1. **Product truth and safety boundaries** — canonical registries, live behaviour, source code, generated canon, setup contract, and documentation.
...
| Task                         | Summary                                                                                                                                                                                             |
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Root README rewrite          | Rewrite the complete root-level README.md file, basing it upon the new branding and messaging rules.                                                                                                |
...
| Publish the ADR              | Number the WIP ADR in `decisions.md` and publish it permanently into `project/map/_adr/` at the end of the effort. Add a second ADR to note about canonicalising the brand docs themselves.         |
| Glossary and Proof migration | Update the canonical glossary with new and refined definitions, and plan the proper Receipt → Proof renaming across the product.                                                                    |
| Registry canonicalisation    | Model the brand system as typed registry data under `scripts/brand/` and generate these documents from it — byte-faithful conversion first, with each document's sign-off gating its conversion.    |
