...
| [`claims-residue.md`](../../_private/brand/claims-residue.md)                                     | Operational     | Holds the private evidence behind the claims system: dated internal snapshots, demand-evidence sweeps, the anecdote ledger, and claims requiring future validation.                                       | private overlay (local) |
