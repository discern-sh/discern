...
| `feature:release-awareness`               | The persistent root update action and clone-local reminder explain this handoff; it must not enter rotating tip history.                                                                     |
...
| `verb:releases`                           | The root update action and release result teach the handoff at the point of use.                                                                                                             |
