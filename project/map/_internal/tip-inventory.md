...
| `feature:setup-environment-probe`         | Setup runs the probe itself and explains its outcome in the completion report; doctor's environment check teaches the recorded proof afterwards.                                             |
