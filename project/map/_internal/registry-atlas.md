...
| [`git-admin-state`](#git-admin-state--git-admin-state)                                                                | `src/shared/git_admin_state.ts#GIT_ADMIN_STATE`                                | 10      | —                | —                           |
...
| [`canonical-sets`](#canonical-sets--canonical-sets)                                                                   | `scripts/canonical_sets.ts#CANONICAL_SETS`                                     | 50      | —                | node `canonical-sets`       |

50 sets · 75 guard tests · 19 committed artifacts.
