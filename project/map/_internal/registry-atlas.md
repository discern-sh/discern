...
| [`adrs`](#adrs--architecture-decision-records)                                                                        | `src/lib/docs.ts#adrRecords`                                                      | 245     | —                | node `adr-discipline`       |
...
| [`canonical-sets`](#canonical-sets--canonical-sets)                                                                   | `scripts/canonical_sets.ts#CANONICAL_SETS`                                        | 62      | —                | node `canonical-sets`       |

62 sets · 92 guard tests · 26 committed artifacts.
