...
| [`hints`](#hints--hints)                                                       | `src/shared/hints.ts#HINTS`                                                    | 128     | "Advisory"       | node `hints`                |
...
| [`adrs`](#adrs--architecture-decision-records)                                 | `src/lib/docs.ts#adrRecords`                                                   | 195     | —                | node `adr-discipline`       |
