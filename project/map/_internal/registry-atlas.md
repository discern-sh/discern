...
| [`hints`](#hints--hints)                                                                                              | `src/shared/hints.ts#HINTS`                                                       | 145     | "Advisory"       | node `hints`                |
...
| [`adrs`](#adrs--architecture-decision-records)                                                                        | `src/lib/docs.ts#adrRecords`                                                      | 205     | —                | node `adr-discipline`       |
