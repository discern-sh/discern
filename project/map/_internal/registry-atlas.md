...
| [`hints`](#hints--hints)                                                                                              | `src/shared/hints.ts#HINTS`                                                       | 147     | "Advisory"       | node `hints`                |
...
| [`adrs`](#adrs--architecture-decision-records)                                                                        | `src/lib/docs.ts#adrRecords`                                                      | 208     | —                | node `adr-discipline`       |
