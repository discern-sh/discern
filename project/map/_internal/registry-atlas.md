...
| [`adrs`](#adrs--architecture-decision-records)                                                                        | `src/lib/docs.ts#adrRecords`                                                      | 361     | —                | node `adr-discipline`       |
...
| [`canonical-sets`](#canonical-sets--canonical-sets)                                                                   | `scripts/canonical_sets.ts#CANONICAL_SETS`                                        | 127     | —                | node `canonical-sets`       |

127 sets · 180 guard tests · 67 committed artifacts.
