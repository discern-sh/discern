...
| [`hints`](#hints--hints)                                                                                              | `src/shared/hints.ts#HINTS`                                                       | 196     | "Advisory"       | node `hints`                |
...
| [`best-effort-boundaries`](#best-effort-boundaries--error-discard-boundaries)                                         | `src/shared/best_effort.ts#BEST_EFFORT_BOUNDARIES`                                | 183     | —                | —                           |
