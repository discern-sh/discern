...
| ---------------------- | ------------------------------------- | ------- |
| Agent file             | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md` | tracked |
