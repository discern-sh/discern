...
| `discern/repository-toolchains/`               | repository | Content-verified development binaries shared by main and every linked worktree.                                       |
