...
- [The walkthrough](../10-installer/walkthrough.md) — the setup session that produced this diff.
- [Files & ownership](../10-installer/artifact-ownership.md) — the complete footprint and how to remove it.
- [Trust & your data](trust-and-data.md) — what runs on your machine, and what never does.
