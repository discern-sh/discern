...
Every term the manual uses is defined once in the [glossary](glossary.md), then used identically everywhere. Fresh from setup? [What setup added to your repo](../10-getting-started/after-setup.md) walks the diff file by file.
