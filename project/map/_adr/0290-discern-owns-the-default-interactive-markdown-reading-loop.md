...
- The sequential reader remains available only when the package returns a typed capability refusal. It intentionally leaves the rendered document in terminal scrollback and waits for Enter.
