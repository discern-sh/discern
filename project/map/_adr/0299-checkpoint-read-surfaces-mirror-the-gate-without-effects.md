...
- A conclusion the next gate run would unbind is never reported as standing — at the cost of a few extra read-only Git operations per recorded open question whose trigger currently holds.
