...
- A checkpoint can fail open because a required fact is unavailable. The durable drop names that loss, and no checkpoint fires from a partial scan or guessed classification.
