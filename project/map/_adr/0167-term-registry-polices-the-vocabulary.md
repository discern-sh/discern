...
- Nothing forced a new closed-set member into the vocabulary. The Gate job and Stage entries interpolate their sets ([ADR 0164](0164-glossary-compiles-from-a-term-registry.md)), but a new top-level verb could ship with the glossary silently lagging the engine.
...
- A new verb, known job, or stage fails the gate until someone decides its vocabulary — an entry, a mention, or a reasoned absence. Seven utility and advisory verbs are recorded absent today; enrolment also pushed two genuine improvements into the Standard and Skill definitions.
