...
**Status**: accepted for its condition vocabulary, read-only execution model, and authoritative-state boundary. Its timing, continuation, branch-arming, and follow-up policies are superseded by [ADR 0232](0232-await-continuations-spend-the-transport-budget.md); [ADR 0227](0227-await-bounds-follow-repository-evidence.md) was the intermediate timing policy. Builds on [ADR 0160](0160-local-logbook-advisory-readers.md)'s advisory-only boundary and [ADR 0210](0210-effectful-verb-starts-are-paired-logbook-events.md)'s begin events; extends the landing model of [ADR 0110](0110-the-landing-model.md)
