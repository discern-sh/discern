...
**Status**: accepted on 2026-09-05; implemented by the complete completion and coordinated acceptance boundaries. Amends [ADR 0110](0110-the-landing-model.md), [ADR 0194](0194-standing-pre-authorization-is-a-recorded-checked-grant.md), and [ADR 0247](0247-generated-artifacts-regenerate-never-merge.md). Amended by [ADR 0389](0389-the-workspace-contract.md) on 2026-09-12: the borrowed substrate is gone, so source authority today attaches to the source checkout's own committed tip; the concept that authority survives a declared composition is retained for the integration-worktree landing. Amended by [ADR 0391](0391-landings-compose-a-moved-trunk-in-an-integration-worktree.md) on 2026-09-12: the declared composition procedure exists — merge-trunk in a discern-created integration worktree — and the candidate records its exact source revisions as a list, the predecessor, and the tested resulting commit separately. Because authority now attaches to the source tip, landing a branch that contains another effort's unlanded commits lands them under the successor's own consent or grant; the rule that a successor's approval never implies its predecessor's no longer holds, and the manual tells owners to approve a successor only when they accept both.
