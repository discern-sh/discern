...
- The default scope is discern-owned code and effects. Configured jobs, resources, hooks, coding-agent clients, and coding-agent host permissions remain outside a claim unless a record includes them. Qualifications belong on the record rather than in corrective footnotes elsewhere.
