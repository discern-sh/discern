...
>
> - **Completion-model direction (2026-09-05; implemented):** [ADR 0374](0374-complete-proof-is-independent-of-measurement-scheduling.md) binds complete Proof to the full requirement set of the exact validated commit while allowing valid component reuse.
