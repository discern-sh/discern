...
> **Component-contract amendment (2026-08-14):** Release 0.14.0 made search defaults, interaction height, Heading leading lines, Confirm geometry, choice markers, step triangles, Result-summary alignment, and Command suggestion grammar package contracts. Terminal value operations use `request*`; their shared contracts use `Interaction*`.
