...
**Status**: accepted; extends the receipt marker of [ADR 0067](0067-accept-validates-the-landed-tree.md), leaves the advisory boundary of [ADR 0160](0160-local-logbook-advisory-readers.md) intact, and deliberately stays outside the consent-gated class of [ADR 0086](0086-setup-serves-relay-messages-and-a-consent-attestation.md)/[ADR 0134](0134-accept-attests-consent.md).
