...
> - **[ADR 0322](0322-setup-is-one-bounded-operational-journey.md) — one probe:** the normal brief no longer creates a manual worktree. Readiness is configured and smoke-tested in the setup checkout; `setup done` remains the sole structural current-HEAD probe and owns teardown.
