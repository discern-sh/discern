...
- **Exemptions are prose a reviewer can audit, in one diff-reviewed place**, not silence. `runShell`'s entry states its condition explicitly: no engine caller today; supervision and a surface before an operator command routes through it.
