...
> - **Accepted completion-model direction (2026-09-05):** [ADR 0378](0378-landing-completion-survives-checkout-retirement.md) retains landing evidence beyond checkout retirement and separates source, authority, and executor. [ADR 0379](0379-emergency-landings-record-an-explicit-proof-exception.md) requires a distinct emergency claim. These accepted changes have implementation pending.
