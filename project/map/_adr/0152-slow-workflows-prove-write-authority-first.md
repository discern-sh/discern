...
> - **[ADR 0338](0338-operation-policy-enrolls-git-write-authority.md) — operation-wide Git writes:** every applied command path that declares a discern-owned Git mutation now proves the broad Git-administration boundary before its body. Gate, Standards, setup, and worktree creation retain their exact plan-derived probes as supplements.
