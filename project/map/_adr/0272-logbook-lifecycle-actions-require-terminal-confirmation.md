...
- **Copy the active directory before detaching it.** Rejected because appenders can change several shards during the copy, producing no single transaction boundary and delaying the fresh start until an unbounded copy finishes.
