...
| [70-reference/](70-reference/)                   | Reference material (a stub awaiting its authoring pass, unpublished until then): the [generated CLI reference](70-reference/cli-reference.md) — every command and flag, emitted by `deno task codegen` from the live command registry.                                                                                                                                                                                                                                |
