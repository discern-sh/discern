...
`discern done` emits a receipt when the run passes on a clean, committed branch that is ahead of trunk. It renders in two forms from one derivation ([ADR 0114](../_adr/0114-the-gate-emits-the-receipt.md), [ADR 0184](../_adr/0184-the-receipt-relays-as-one-line.md)):
