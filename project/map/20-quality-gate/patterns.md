...
| Gate fit   | One job or the generated family dominating gate time, duration creep on an unchanged setup, an idle fix stage, one diagnostic class across branches, and divergent verdicts on an identical tree.                                                                                                                                                                                                                                                                                                                                                                          |
