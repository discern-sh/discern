...
Where [`done`](../../../src/engine/gate/finish.ts) asks _did this change pass?_
...
([`src/engine/improve/`](../../../src/engine/improve/rules.ts)), ranks the
weakest areas, and selects one prioritized next action. It is advisory by
default: a completed review succeeds, while its baseline and open work live in
the result.
