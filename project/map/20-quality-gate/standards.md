...
The human Gate renders a measured or replayed value through the package StandardMeter, retaining its exact value, floor or ceiling, headroom, and held, improved, or regressed trajectory. A ResultSummary beside it names whether the reading was measured, replayed, deferred, or skipped, plus its source commit, duration, margin, and pin eligibility when present. Deferred and skipped readings never manufacture a value. These Components present the existing `GateStandard` fact; comparison and pin eligibility remain Gate-owned decisions.
