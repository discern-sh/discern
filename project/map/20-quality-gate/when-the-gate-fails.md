...
| `done` refused an unchanged-tree rerun       | Fix or change the failed state. For an explicit retry, run `discern done --rerun`. Valid exact green Proof returns without jobs.                                                                                                                                                                                                                                                        |
