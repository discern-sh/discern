...
| Checkpoints          | Per-checkpoint economics: efforts fired, servings, declarations with unchanged-subject and unmet splits, variances across landed efforts, abandoned episodes, median time to declare. Most-served rows; remainder counted.        |
