...
| Checkpoints          | Per-checkpoint economics: efforts fired on, servings, declarations with unchanged-subject and unmet splits, variances across landed efforts, abandoned episodes, and median time to declare — the most-served rows, remainder counted. |
