...
| Checkpoints          | Observed per-checkpoint economics: efforts fired on out of efforts observed, servings, declarations with their unchanged-subject and unmet splits, authorized variances across landed efforts, abandoned episodes, and the median time from serving to declaration. Bounded to the most-served rows with the remainder counted. |
