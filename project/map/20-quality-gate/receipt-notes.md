...
After the trunk fast-forward, `discern accept` writes the durable receipt record under `refs/notes/discern` ([ADR 0215](../_adr/0215-landing-receipts-travel-as-git-notes.md), [ADR 0241](../_adr/0241-durable-receipts-travel-versioned-and-signature-ready.md)). It adds no trunk commit.
