...
| [`strand-detection.md`](strand-detection.md)       | Why a green gate must leave the tracked tree as it found it: any stage that dirties a committed-clean file blocks `done`, attributed to its origin stage ([ADR 0148](../_adr/0148-strand-detection-covers-every-gate-stage.md)).                                    |
