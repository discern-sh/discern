...
Commit the final tree and run `discern done`. A landing then needs one verified source of owner consent:

- `discern accept --confirmed` attests that the owner accepted this landing in the current conversation.
