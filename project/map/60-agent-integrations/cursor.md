...
| File                 | Role                                                | Ownership                       |
| -------------------- | --------------------------------------------------- | ------------------------------- |
| `AGENTS.md`          | Canonical compiled agent file Cursor reads directly | Generated by canonical provider |
...
- Why Cursor emits no provider-specific compiled agent file ([ADR 0070](../_adr/0070-reuse-canonical-guidance.md)).
