...
Completion records have one reader, for their launch shape. discern launches at schema version 1: a pre-launch shape has no reader, supplies no fields, passing outcome, or authority, and is cleaned by hand. Unsupported versions and corrupt records retain distinct results.
