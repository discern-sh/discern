...
| I want to…                    | Go here                                                                                                                                              |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Update my branch from main    | [Bring the trunk into the branch](../30-worktrees/lifecycle.md#bring-the-trunk-into-the-branch), review the incoming overlap, and rerun the gate.    |
