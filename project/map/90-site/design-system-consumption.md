...
[`site/page-src/benefit-quality-contour.tsx`](../../../site/page-src/benefit-quality-contour.tsx) owns the reusable Scalable Vector Graphics (SVG) artwork for the Quality that only improves benefit. Registry-driven, softly faceted boundaries tighten toward a split triangular culmination. Each boundary's authored bounds derive a transform onto one compact footprint around the triangle, then all expand to their exact identity transform and hold before a hidden loop reset. The contours remain monochrome while the small triangle carries the restrained accent. [`site/page-src/benefit-quality-contour-preview.tsx`](../../../site/page-src/benefit-quality-contour-preview.tsx) presents the study inside fixed light and dark token roots, while [`site/page-src/benefit-quality-contour.css`](../../../site/page-src/benefit-quality-contour.css) owns its responsive composition and reduced-motion culmination. The earlier homepage artefact sheet remains authored in [`site/page-src/specimens.tsx`](../../../site/page-src/specimens.tsx) and [`site/page-src/specimens.css`](../../../site/page-src/specimens.css), outside the current focused preview.
