...
The [release runbook](../../project/map/_private/maintainer/release-runbook.md) owns the later activation sequence. Do not create the Gist, install or configure CLA Assistant, or accept an external contribution until that sequence records the storage and privacy details and changes the repository's intake status coherently.
