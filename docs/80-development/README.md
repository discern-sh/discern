...
| [testing.md](testing.md)                         | The two test layers (installer subprocess + engine shell-out against the real templates), the temp-dir / hermetic-git harness, and the parallel-safe patterns the gate assumes.                                             |
