...
| `AGENTS.md`                          | generated | The **canonical** agent file — holds the full compiled body the mirrors import; Cursor and the Copilot CLI read it natively. Gitignored (ADR 0034); a stale one fails `discern done`'s guidance-currency check.                              |
