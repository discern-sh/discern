...
smoke — once.** discern turns those declarations into the rails — a gate, isolated
...
runs in from its name, so you never write a scheduling keyword. Anything outside those
