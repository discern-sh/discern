...
| [20-quality-gate/](20-quality-gate/)         | `discern finish` and the Capability/Check execution model — fix · build · check · test — plus Scope classification (and Scope gates), and Ratchets.                                                                                                                                                                                                                                                                       |
...
| [40-agent-guidance/](40-agent-guidance/)     | Author-once → compile-everywhere: the Guidance source, the `discern guidelines` compiler, the Compiled agent files, and the bundled Skills.                                                                                                                                                                                                                                                                               |
