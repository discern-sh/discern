...
| [20-quality-gate/](20-quality-gate/)             | `discern done` and the Capability/Check execution model — fix · build · check · test — plus Scope classification (and Scope gates), Ratchets, and the [`improvement`](20-quality-gate/improvement.md) continuous-improvement coach.                                                                                                                                                                                                                                   |
