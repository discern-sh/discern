# icculus documentation

The full documentation tree for icculus. Audience is layered: each subtree's
...
| Path                                         | What's in it                                                                                                                                                                                                                                                                                                                                                                                                         |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [10-installer/](10-installer/)               | The Deno/TypeScript **Installer**: `init`, `upgrade`, `doctor`, `migrate`, `config`, `add-preset`, the `templates/` → install copy by disposition, the Manifest, and the Schema-version Migration chain.                                                                                                                                                                                                             |
| [20-quality-gate/](20-quality-gate/)         | `agent finish` and the Capability/Check execution model — fix · build · check · test — plus Scope classification (and Scope gates), and Ratchets.                                                                                                                                                                                                                                                                    |
| [30-worktrees/](30-worktrees/)               | The isolated-Worktree workflow: lifecycle (create · ensure · exit · teardown · prune), per-Worktree identity (name · port · site · db), and the database & dev-server worktree settings.                                                                                                                                                                                                                             |
...
| [80-development/](80-development/)           | Working on icculus: getting set up, the [notes for humans](80-development/for-humans.md) (IDE setup and local prerequisites), the testing approach, code conventions, the [install surface](80-development/install-surface.md) (what an install contains, managed vs yours), and the [finish-gate gotchas](80-development/finish-gate-gotchas.md) the quality gate points at when a step fails in a non-obvious way. |
