...
| [80-development/](80-development/) | Working on icculus: getting set up, the testing approach, code conventions, the [install surface](80-development/install-surface.md) (what an install contains, managed vs seed), and the [finish-gate gotchas](80-development/finish-gate-gotchas.md) the quality gate points at when a step fails in a non-obvious way. |
