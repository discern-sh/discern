...
**Status**: accepted; supersedes the _tracking_ decision in
[ADR 0032](0032-claude-md-imports-agents-md.md) and revises the `tracked` flag
from [ADR 0031](0031-typed-provider-integration.md). Builds on the orientation
verb from [ADR 0033](0033-status-verb-and-location-aware-scope.md).
