...
1. **A do-not-edit banner** at the very top of every generated file (an HTML
   comment — "GENERATED by discern refresh — do NOT edit this file"), and a
   second, longer banner inside the `CLAUDE.md` pointer.
