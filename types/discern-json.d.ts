// GENERATED by `deno task codegen` from src/shared/result.ts, src/shared/result_completion.ts, src/shared/result_contracts.ts, and src/shared/result_schemas.ts. Do NOT edit by hand.
