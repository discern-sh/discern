...
> pointers reflect the suggestable-command surface that replaced the old Recipe
...
registration, suggestable-command surface, MCP table, grouped help, schemas, and
tests to move in lockstep.
