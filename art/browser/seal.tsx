...
/**
 * Placeholder composition for the seal figure. The authored SVG is the
  ...
  return (
    <figure className="fig fig-seal">
      ...
      >
        ...
        <g aria-hidden="true">
          <polygon
            className="fig-seal__placeholder"
            points="380,214 330,326 430,326"
          />
          <polygon
            className="fig-seal__placeholder-fill"
