...
/**
 * Placeholder composition for the interference figure. The authored SVG is
 * the complete resolved state; the stylesheet supplies the journey into it.
 */
  ...
  return (
    <figure className="fig fig-interference">
      ...
      >
        ...
        <g aria-hidden="true">
          <polygon
            className="fig-interference__placeholder"
            points="380,214 330,326 430,326"
          />
          <polygon
            className="fig-interference__placeholder-fill"
