...
/**
 * Placeholder composition for the ratchet figure. The authored SVG is the
  ...
  return (
    <figure className="fig fig-ratchet">
      ...
      >
        ...
        <g aria-hidden="true">
          <polygon
            className="fig-ratchet__placeholder"
            points="380,214 330,326 430,326"
          />
          <polygon
            className="fig-ratchet__placeholder-fill"
