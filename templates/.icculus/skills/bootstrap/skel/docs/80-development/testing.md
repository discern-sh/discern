...
The `test` capability in `.icculus/config.toml` is what `agent finish` runs; this doc explains how to write tests that pass it and how to run them while iterating.
