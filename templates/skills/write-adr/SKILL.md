...
ADRs live in `docs/_adr/`. If that directory doesn't exist yet — a project that hasn't run `discern setup` — create it from this skill's skeleton before writing: copy `.claude/skills/write-adr/skel/docs/_adr/` (the canonical `README.md` format guide and `0000-template.md`) to `docs/_adr/`. If it already exists, skip this.
