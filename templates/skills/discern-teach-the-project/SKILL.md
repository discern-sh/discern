...
| A significant architectural choice meeting the project’s ADR criteria        | **An ADR** — via the `discern-write-adr` skill                                                             | Records _why_, so it isn't silently re-litigated                                                |
