...
The tree at `{{docs_dir}}` is the **map** — the agent-maintained account of this
codebase, browsable with **`discern_docs`**. Agents write it and keep it current;
...
**Architecture Decision Records** under `{{docs_dir}}_adr/`.
