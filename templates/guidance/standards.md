...
**Never loosen one to pass.** A loosened or deleted limit fails the gate — that is the standard working. Move the _metric_ the right way; lowering a limit is an owner decision, taken on the trunk.{{/if}}
