...
- **`discern done`** verifies the clean, committed final tree and records completion evidence. Follow its next action for landing; a passing gate does not grant permission to land.
