...
> This doc is a skeleton. The `discern setup` command writes it from the project's actual stack and the Conventions section of the project instructions. Look for the `<!-- setup fills this -->` marker.
