...
> This doc is a skeleton. The `discern bootstrap` command fills it from the brief at `brief.md`. The map is **ASCII-first** so it lives in the text and stays diffable — draw the boxes and arrows below.
