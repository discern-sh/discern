...
1. Run **`discern refresh`** to compile the built-in harness guidance + `guidance.md` into the per-provider agent files (`AGENTS.md`, `CLAUDE.md`, `GEMINI.md` — all gitignored build artifacts) and materialize the skills into `.claude/skills/`.
