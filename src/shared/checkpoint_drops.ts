...
export const CHECKPOINT_DROP_REASON_REGISTRY = [
  ...
  { reason: "checkpoint_question_file_missing", scopes: ["checkpoint"] },
  {
    reason: "checkpoint_question_file_invalid_path",
    scopes: ["checkpoint"],
  },
  { reason: "checkpoint_question_file_not_regular", scopes: ["checkpoint"] },
  { reason: "checkpoint_question_file_oversized", scopes: ["checkpoint"] },
  { reason: "checkpoint_question_file_invalid_utf8", scopes: ["checkpoint"] },
  { reason: "checkpoint_question_file_unreadable", scopes: ["checkpoint"] },
  { reason: "checkpoint_question_source_conflict", scopes: ["checkpoint"] },
  ...
  { reason: "trigger_content_unavailable", scopes: ["checkpoint"] },
  { reason: "trigger_history_unavailable", scopes: ["checkpoint"] },
  ...
  { reason: "when_cancelled", scopes: ["checkpoint"] },
  { reason: "when_input_failed", scopes: ["checkpoint"] },
  { reason: "when_input_cleanup_failed", scopes: ["checkpoint"] },
  { reason: "when_output_limit", scopes: ["checkpoint"] },
