...
export function renderContentDesignDemo(stats: DemoStats): string {
  const body = renderToStaticMarkup(<ContentDemoPage stats={stats} />);
  return `<!doctype html>
<!-- Generated by site/build.ts from site/page-src/content-design-demo.tsx. Do not edit. -->
<html lang="en" data-ds-theme="light">
<head>
<meta charset="utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<title>discern · Editorial engineering content atlas</title>
<meta name="description" content="A content-focused design-system demo for essays, reports, technical narratives, and premium reading experiences." />
