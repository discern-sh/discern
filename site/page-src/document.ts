...
import type { AppearanceProjection } from "discern-design-system";
...
export interface PageDocument {
  ...
  /** Page colour projection; defaults to the shared site Accent. */
...
<html lang="en" ${
    siteAppearanceRootAttributes(page.appearance)
